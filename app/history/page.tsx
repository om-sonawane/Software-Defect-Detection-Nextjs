...
import { Loader2, ArrowLeft, Calendar, Clock, AlertTriangle, CheckCircle, Download } from "lucide-react"
...
export default function HistoryPage() {
  ...
  const handleDownloadReport = async (result: DefectResult) => {
    setDownloadingReport(result.id)
    try {
      await generateAndDownloadReport(result)
    } catch (error) {
                          ...
                          <CardContent className="p-4">
                            ...
                            <div className="mt-3 flex justify-end">
                              <Button
                                ...
                                disabled={downloadingReport === result.id}
                              >
                                {downloadingReport === result.id ? (
                                  <>
